...
```spl
notable, risk, index=* (by data model: Authentication, Endpoint, Network_Traffic, Change) (admin OR role OR privilege OR "add member" OR "grant")
