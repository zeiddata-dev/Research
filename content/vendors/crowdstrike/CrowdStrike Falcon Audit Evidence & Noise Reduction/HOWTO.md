# HOWTO — Implement Audit Evidence + Noise Reduction in Falcon
...
```bash
python 02-exclusions/tools/scripts/create_ml_exclusions_from_csv.py   --csv 02-exclusions/sample_ml_exclusions.csv   --dry-run
```
