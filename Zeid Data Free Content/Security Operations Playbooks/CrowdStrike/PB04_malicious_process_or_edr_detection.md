# Zeid Data Security Playbooks — CrowdStrike — Malicious Process or EDR Detection

**Authorized SOC use only. Use only on systems/data you own or have explicit permission to analyze.**

**Playbook ID:** CRO-PB04  
**Vendor:** CrowdStrike  
...
**CrowdStrike pivots:**
- Process tree lineage, hash reputation, related detections, host isolation decision.

**Splunk (example):**

```spl
index=crowdstrike* sourcetype=crowdstrike:* (process_name OR Image OR CommandLine OR detection)
