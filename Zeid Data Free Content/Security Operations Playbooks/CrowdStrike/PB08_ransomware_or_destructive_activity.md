# Zeid Data Security Playbooks — CrowdStrike — Ransomware or Destructive Activity

**Authorized SOC use only. Use only on systems/data you own or have explicit permission to analyze.**

**Playbook ID:** CRO-PB08  
**Vendor:** CrowdStrike  
...
```spl
index=crowdstrike* sourcetype=crowdstrike:* (ransom OR encrypt OR "mass rename" OR "shadow copy")
