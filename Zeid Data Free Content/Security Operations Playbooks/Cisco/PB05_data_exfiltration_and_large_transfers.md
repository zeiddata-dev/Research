...
**Vendor note:** Cisco playbooks lean network-first: DNS, firewall, VPN, email security where available.
...
```spl
index=cisco* sourcetype in (cisco:asa, cisco:ftd, cisco:umbrella, netflow) (bytes_out OR sent_bytes OR download OR upload)
