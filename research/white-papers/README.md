...
<p align="center">
  <img src="../../assets/banners/readme/white_papers.png" alt="Zeid Data white_papers banner" width="100%">
</p>
...
- `projects/`  
  Runnable tools and utilities (CLI/tools/scripts/apps). If you can run it, it belongs here.
...
- `docs/`  
  ...
  - `docs/guides/index.md` (how to navigate)
  - `docs/guides/taxonomy.md` (what goes where)
  - `docs/guides/standards/naming.md` (naming rules)
  - `docs/guides/standards/evidence.md` (evidence expectations)
...
- `research/research/malware/<family>/`
- `research/ops/<topic>/`
