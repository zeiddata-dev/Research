...
- Network-relevant TTPs called out include tunneling/proxying with Ngrok and proxy-bot tooling, plus common data exfil via Rclone/WinSCP and cloud transfers.
...
- Ngrok/legit-tunnel abuse: look for rare TLS SNI/hostnames, known Ngrok ASNs/IP ranges in egress allowlists, and sudden spikes in long-lived outbound 443 from servers.
- Rclone-style bulk sync: sustained high-volume HTTPS to cloud storage providers from atypical hosts/users, with new user-agents / process lineage on endpoints (rclone.exe, or renamed binaries).
- Remote service execution + lateral movement: bursts of SMB/RPC + RDP/SSH between peers, especially after credential-dump signals or new local admin creation.
...
## 11) Sources (receipts)
- [FBI/CISA/DC3/HHS #StopRansomware Akira advisory update (Nov 13, 2025) [PDF]](https://www.ic3.gov/CSA/2025/251113.pdf)
- [CISA alert about advisory update (Nov 13, 2025)](https://www.cisa.gov/news-events/alerts/2025/11/13/cisa-and-partners-release-advisory-update-akira-ransomware)
- [CyberScoop coverage citing proceeds & targeting (Nov 13, 2025)](https://cyberscoop.com/akira-ransomware-fbi-cisa-joint-advisory/)
- [Dark Reading: Flashpoint midyear 2025 prolific groups (Aug 28, 2025)](https://www.darkreading.com/threat-intelligence/akira-clop-top-5-most-active-ransomware-groups-list)
