# Zeid Data Security Playbooks — Google Workspace — Command and Control Beaconing

**Authorized SOC use only. Use only on systems/data you own or have explicit permission to analyze.**

**Playbook ID:** GOO-PB06  
...
```spl
index=google_workspace* sourcetype in (gws:login, gws:admin, gws:drive, gws:gmail) (dest_port=443 OR dest_port=80)
