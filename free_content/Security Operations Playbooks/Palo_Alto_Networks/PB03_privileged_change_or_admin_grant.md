# Zeid Data Security Playbooks — Palo Alto Networks — Privileged Change or Admin Grant

**Authorized SOC use only. Use only on systems/data you own or have explicit permission to analyze.**

**Playbook ID:** PAL-PB03  
...
```spl
index=pan* sourcetype in (pan:traffic, pan:threat, pan:url, pan:globalprotect) (admin OR role OR privilege OR "add member" OR "grant")
