...
**Cisco pivots:**
- Umbrella: repetitive DNS queries, newly seen domains, suspicious categories.
- Firewall: periodic outbound 443 to rare destinations with low data volume.

**Splunk (example):**

```spl
index=cisco* sourcetype in (cisco:asa, cisco:ftd, cisco:umbrella, netflow) (dest_port=443 OR dest_port=80)
