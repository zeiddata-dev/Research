...
```spl
notable, risk, index=* (by data model: Authentication, Endpoint, Network_Traffic, Change) (ransom OR encrypt OR "mass rename" OR "shadow copy")
