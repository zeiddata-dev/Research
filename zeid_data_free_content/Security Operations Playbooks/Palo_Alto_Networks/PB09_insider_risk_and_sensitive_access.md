# Zeid Data Security Playbooks — Palo Alto Networks — Insider Risk and Sensitive Access

**Authorized SOC use only. Use only on systems/data you own or have explicit permission to analyze.**

**Playbook ID:** PAL-PB09  
...
```spl
index=pan* sourcetype in (pan:traffic, pan:threat, pan:url, pan:globalprotect) (sensitive OR confidential OR pii OR export)
