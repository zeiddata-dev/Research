# Zeid Data Security Playbooks — CrowdStrike — Data Exfiltration and Large Transfers

**Authorized SOC use only. Use only on systems/data you own or have explicit permission to analyze.**

**Playbook ID:** CRO-PB05  
**Vendor:** CrowdStrike  
...
**Vendor note:** CrowdStrike playbooks lean endpoint-first: process trees, lateral movement, containment actions.
...
```spl
index=crowdstrike* sourcetype=crowdstrike:* (bytes_out OR sent_bytes OR download OR upload)
