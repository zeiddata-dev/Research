# Zeid Data Security Playbooks — Google Workspace — Ransomware or Destructive Activity

**Authorized SOC use only. Use only on systems/data you own or have explicit permission to analyze.**

**Playbook ID:** GOO-PB08  
...
```spl
index=google_workspace* sourcetype in (gws:login, gws:admin, gws:drive, gws:gmail) (ransom OR encrypt OR "mass rename" OR "shadow copy")
