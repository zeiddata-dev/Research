# Zeid Data Security Playbooks — Google Workspace — Data Exfiltration and Large Transfers

**Authorized SOC use only. Use only on systems/data you own or have explicit permission to analyze.**

**Playbook ID:** GOO-PB05  
...
```spl
index=google_workspace* sourcetype in (gws:login, gws:admin, gws:drive, gws:gmail) (bytes_out OR sent_bytes OR download OR upload)
