...
**Vendor note:** AWS playbooks focus on IAM, API calls, suspicious infrastructure activity, and data access.
...
```spl
index=aws* sourcetype in (aws:cloudtrail, aws:guardduty, aws:securityhub, aws:vpcflow) (bytes_out OR sent_bytes OR download OR upload)
