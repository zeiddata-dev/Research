# Zeid Data Security Playbooks — Palo Alto Networks — Ransomware or Destructive Activity

**Authorized SOC use only. Use only on systems/data you own or have explicit permission to analyze.**

**Playbook ID:** PAL-PB08  
...
```spl
index=pan* sourcetype in (pan:traffic, pan:threat, pan:url, pan:globalprotect) (ransom OR encrypt OR "mass rename" OR "shadow copy")
