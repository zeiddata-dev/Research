# Zeid Data Security Playbooks — Palo Alto Networks — Malicious Process or EDR Detection

**Authorized SOC use only. Use only on systems/data you own or have explicit permission to analyze.**

**Playbook ID:** PAL-PB04  
...
```spl
index=pan* sourcetype in (pan:traffic, pan:threat, pan:url, pan:globalprotect) (process_name OR Image OR CommandLine OR detection)
