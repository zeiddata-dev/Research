# Zeid Data Security Playbooks — Palo Alto Networks — Command and Control Beaconing

**Authorized SOC use only. Use only on systems/data you own or have explicit permission to analyze.**

**Playbook ID:** PAL-PB06  
...
```spl
index=pan* sourcetype in (pan:traffic, pan:threat, pan:url, pan:globalprotect) (dest_port=443 OR dest_port=80)
