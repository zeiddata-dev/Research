# Zeid Data Security Playbooks — Google Workspace — Malicious Process or EDR Detection

**Authorized SOC use only. Use only on systems/data you own or have explicit permission to analyze.**

**Playbook ID:** GOO-PB04  
...
```spl
index=google_workspace* sourcetype in (gws:login, gws:admin, gws:drive, gws:gmail) (process_name OR Image OR CommandLine OR detection)
