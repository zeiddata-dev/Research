# Zeid Data Security Playbooks — Databricks — Data Exfiltration and Large Transfers

**Authorized SOC use only. Use only on systems/data you own or have explicit permission to analyze.**

**Playbook ID:** DAT-PB05  
**Vendor:** Databricks  
...
```spl
index=databricks* sourcetype=databricks:audit (bytes_out OR sent_bytes OR download OR upload)
